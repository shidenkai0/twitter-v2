...
class MentionEntity(BaseModel):
    ...
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique identifier of this User. This is returned as a string in order to avoid complications with languages and tools that cannot handle large integers.")
    username: Annotated[str, Field(strict=True)] = Field(description="The Twitter handle (screen name) of this user.")
    __properties: ClassVar[List[str]] = ["end", "start", "id", "username"]
