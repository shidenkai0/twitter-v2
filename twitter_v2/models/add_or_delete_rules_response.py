...
class AddOrDeleteRulesResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[Rule]] = Field(default=None, description="All user-specified stream filtering rules that were created.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [Rule.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "errors": [Problem.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "meta": RulesResponseMetadata.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj
