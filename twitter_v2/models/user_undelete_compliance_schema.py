...
class UserUndeleteComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_undelete"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_undelete": UserComplianceSchema.from_dict(obj.get("user_undelete")) if obj.get("user_undelete") is not None else None
        })
        return _obj
