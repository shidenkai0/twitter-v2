...
class VideoAllOfNonPublicMetrics(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["playback_0_count", "playback_100_count", "playback_25_count", "playback_50_count", "playback_75_count"]
