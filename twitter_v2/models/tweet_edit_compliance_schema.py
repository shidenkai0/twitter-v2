...
class TweetEditComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tweet_edit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tweet_edit
        if self.tweet_edit:
            _dict['tweet_edit'] = self.tweet_edit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tweet_edit": TweetEditComplianceObjectSchema.from_dict(obj.get("tweet_edit")) if obj.get("tweet_edit") is not None else None
        })
        return _obj
