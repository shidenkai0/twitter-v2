...
class ResourceNotFoundProblem(Problem):
    ...
    value: StrictStr = Field(description="Value will match the schema of the field.")
    __properties: ClassVar[List[str]] = ["detail", "status", "title", "type", "parameter", "resource_id", "resource_type", "value"]
