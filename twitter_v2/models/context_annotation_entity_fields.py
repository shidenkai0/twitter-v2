...
class ContextAnnotationEntityFields(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the context annotation entity.")
    id: Annotated[str, Field(strict=True)] = Field(description="The unique id for a context annotation entity.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the context annotation entity.")
