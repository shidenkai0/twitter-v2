...
class FullTextEntities(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "annotations": [FullTextEntitiesAnnotationsInner.from_dict(_item) for _item in obj.get("annotations")] if obj.get("annotations") is not None else None,
            "cashtags": [CashtagEntity.from_dict(_item) for _item in obj.get("cashtags")] if obj.get("cashtags") is not None else None,
            "hashtags": [HashtagEntity.from_dict(_item) for _item in obj.get("hashtags")] if obj.get("hashtags") is not None else None,
            "mentions": [MentionEntity.from_dict(_item) for _item in obj.get("mentions")] if obj.get("mentions") is not None else None,
            "urls": [UrlEntity.from_dict(_item) for _item in obj.get("urls")] if obj.get("urls") is not None else None
        })
        return _obj
