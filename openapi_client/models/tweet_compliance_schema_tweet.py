...
class TweetComplianceSchemaTweet(BaseModel):
    ...
    """ # noqa: E501
    author_id: Annotated[str, Field(strict=True)] = Field(description="Unique identifier of this User. This is returned as a string in order to avoid complications with languages and tools that cannot handle large integers.")
    ...
    __properties: ClassVar[List[str]] = ["author_id", "id"]
