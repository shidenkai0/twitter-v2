...
class UserWithheldComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_withheld"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_withheld
        if self.user_withheld:
            _dict['user_withheld'] = self.user_withheld.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_withheld": UserTakedownComplianceSchema.from_dict(obj.get("user_withheld")) if obj.get("user_withheld") is not None else None
        })
        return _obj
