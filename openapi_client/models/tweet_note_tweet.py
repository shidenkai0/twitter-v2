...
class TweetNoteTweet(BaseModel):
    ...
    """ # noqa: E501
    entities: Optional[TweetNoteTweetEntities] = None
    text: Optional[StrictStr] = Field(default=None, description="The note content of the Tweet.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "entities": TweetNoteTweetEntities.from_dict(obj.get("entities")) if obj.get("entities") is not None else None,
            "text": obj.get("text")
        })
        return _obj
