...
class UserUnsuspendComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_unsuspend"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_unsuspend": UserComplianceSchema.from_dict(obj.get("user_unsuspend")) if obj.get("user_unsuspend") is not None else None
        })
        return _obj
