...
class UsageCapExceededProblem(Problem):
    ...
    __properties: ClassVar[List[str]] = ["detail", "status", "title", "type", "period", "scope"]
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in ('Account', 'Product'):
            raise ValueError("must be one of enum values ('Account', 'Product')")
        return value
