...
class ResourceUnauthorizedProblem(Problem):
    ...
    section: StrictStr
    value: StrictStr
    __properties: ClassVar[List[str]] = ["detail", "status", "title", "type", "parameter", "resource_id", "resource_type", "section", "value"]
    ...
    def section_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('data', 'includes'):
            raise ValueError("must be one of enum values ('data', 'includes')")
        return value
