...
class TestGet2SpacesByCreatorIdsResponse(unittest.TestCase):
    """Get2SpacesByCreatorIdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2SpacesByCreatorIdsResponse:
        """Test Get2SpacesByCreatorIdsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2SpacesByCreatorIdsResponse`
        """
        model = Get2SpacesByCreatorIdsResponse()
        if include_optional:
    ...
    def testGet2SpacesByCreatorIdsResponse(self):
        """Test Get2SpacesByCreatorIdsResponse"""
