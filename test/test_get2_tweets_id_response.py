...
class TestGet2TweetsIdResponse(unittest.TestCase):
    """Get2TweetsIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsIdResponse:
        """Test Get2TweetsIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsIdResponse`
        """
        model = Get2TweetsIdResponse()
        if include_optional:
    ...
    def testGet2TweetsIdResponse(self):
        """Test Get2TweetsIdResponse"""
