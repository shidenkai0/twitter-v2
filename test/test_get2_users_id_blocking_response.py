...
class TestGet2UsersIdBlockingResponse(unittest.TestCase):
    """Get2UsersIdBlockingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdBlockingResponse:
        """Test Get2UsersIdBlockingResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdBlockingResponse`
        """
        model = Get2UsersIdBlockingResponse()
        if include_optional:
    ...
    def testGet2UsersIdBlockingResponse(self):
        """Test Get2UsersIdBlockingResponse"""
