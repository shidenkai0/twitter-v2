...
class TestGet2TweetsSampleStreamResponse(unittest.TestCase):
    """Get2TweetsSampleStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsSampleStreamResponse:
        """Test Get2TweetsSampleStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsSampleStreamResponse`
        """
        model = Get2TweetsSampleStreamResponse()
        if include_optional:
            return Get2TweetsSampleStreamResponse(
    ...
    def testGet2TweetsSampleStreamResponse(self):
        """Test Get2TweetsSampleStreamResponse"""
