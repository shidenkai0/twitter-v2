...
class TestGet2TweetsResponse(unittest.TestCase):
    """Get2TweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsResponse:
        """Test Get2TweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsResponse`
        """
        model = Get2TweetsResponse()
        if include_optional:
    ...
    def testGet2TweetsResponse(self):
        """Test Get2TweetsResponse"""
