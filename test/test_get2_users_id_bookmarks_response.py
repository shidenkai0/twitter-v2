...
class TestGet2UsersIdBookmarksResponse(unittest.TestCase):
    """Get2UsersIdBookmarksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdBookmarksResponse:
        """Test Get2UsersIdBookmarksResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdBookmarksResponse`
        """
        model = Get2UsersIdBookmarksResponse()
        if include_optional:
    ...
    def testGet2UsersIdBookmarksResponse(self):
        """Test Get2UsersIdBookmarksResponse"""
