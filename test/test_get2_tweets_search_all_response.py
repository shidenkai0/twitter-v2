...
class TestGet2TweetsSearchAllResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Get2TweetsSearchAllResponse:
        """Test Get2TweetsSearchAllResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsSearchAllResponse`
        """
        model = Get2TweetsSearchAllResponse()
        if include_optional:
