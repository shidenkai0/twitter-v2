...
class TestFilteredStreamingTweetResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FilteredStreamingTweetResponse:
        """Test FilteredStreamingTweetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilteredStreamingTweetResponse`
        """
        model = FilteredStreamingTweetResponse()
        if include_optional:
            return FilteredStreamingTweetResponse(
                ...
                matching_rules = [
                    openapi_client.models.filtered_streaming_tweet_response_matching_rules_inner.FilteredStreamingTweetResponse_matching_rules_inner(
