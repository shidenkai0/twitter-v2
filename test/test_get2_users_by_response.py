...
class TestGet2UsersByResponse(unittest.TestCase):
    """Get2UsersByResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersByResponse:
        """Test Get2UsersByResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersByResponse`
        """
        model = Get2UsersByResponse()
        if include_optional:
    ...
    def testGet2UsersByResponse(self):
        """Test Get2UsersByResponse"""
