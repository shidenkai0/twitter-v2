...
class TestGet2TweetsFirehoseStreamResponse(unittest.TestCase):
    """Get2TweetsFirehoseStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsFirehoseStreamResponse:
        """Test Get2TweetsFirehoseStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsFirehoseStreamResponse`
        """
        model = Get2TweetsFirehoseStreamResponse()
        if include_optional:
            return Get2TweetsFirehoseStreamResponse(
    ...
    def testGet2TweetsFirehoseStreamResponse(self):
        """Test Get2TweetsFirehoseStreamResponse"""
