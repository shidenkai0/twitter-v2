...
class TestMuteUserMutationResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MuteUserMutationResponseData:
        """Test MuteUserMutationResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MuteUserMutationResponseData`
        """
        model = MuteUserMutationResponseData()
        if include_optional:
