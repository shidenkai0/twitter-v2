...
class TestGet2UsersMeResponse(unittest.TestCase):
    """Get2UsersMeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersMeResponse:
        """Test Get2UsersMeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersMeResponse`
        """
        model = Get2UsersMeResponse()
        if include_optional:
    ...
    def testGet2UsersMeResponse(self):
        """Test Get2UsersMeResponse"""
