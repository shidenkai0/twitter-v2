...
class TestMuteUserMutationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MuteUserMutationResponse:
        """Test MuteUserMutationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MuteUserMutationResponse`
        """
        model = MuteUserMutationResponse()
        if include_optional:
            return MuteUserMutationResponse(
                data = openapi_client.models.mute_user_mutation_response_data.MuteUserMutationResponse_data(
                    muting = True, ),
                errors = [
