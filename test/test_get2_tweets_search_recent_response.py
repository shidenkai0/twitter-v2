...
class TestGet2TweetsSearchRecentResponse(unittest.TestCase):
    """Get2TweetsSearchRecentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsSearchRecentResponse:
        """Test Get2TweetsSearchRecentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsSearchRecentResponse`
        """
        model = Get2TweetsSearchRecentResponse()
        if include_optional:
            return Get2TweetsSearchRecentResponse(
                ...
                meta = openapi_client.models.get2_tweets_search_all_response_meta.Get2TweetsSearchAllResponse_meta(
                    newest_id = '', 
                    next_token = '0', 
                    oldest_id = '', 
                    result_count = 56, )
    ...
    def testGet2TweetsSearchRecentResponse(self):
        """Test Get2TweetsSearchRecentResponse"""
