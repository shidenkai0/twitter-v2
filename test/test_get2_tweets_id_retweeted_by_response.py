...
class TestGet2TweetsIdRetweetedByResponse(unittest.TestCase):
    """Get2TweetsIdRetweetedByResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsIdRetweetedByResponse:
        """Test Get2TweetsIdRetweetedByResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsIdRetweetedByResponse`
        """
        model = Get2TweetsIdRetweetedByResponse()
        if include_optional:
    ...
    def testGet2TweetsIdRetweetedByResponse(self):
        """Test Get2TweetsIdRetweetedByResponse"""
