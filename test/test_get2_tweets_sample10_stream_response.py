...
class TestGet2TweetsSample10StreamResponse(unittest.TestCase):
    """Get2TweetsSample10StreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsSample10StreamResponse:
        """Test Get2TweetsSample10StreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsSample10StreamResponse`
        """
        model = Get2TweetsSample10StreamResponse()
        if include_optional:
    ...
    def testGet2TweetsSample10StreamResponse(self):
        """Test Get2TweetsSample10StreamResponse"""
