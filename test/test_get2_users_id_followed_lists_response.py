...
class TestGet2UsersIdFollowedListsResponse(unittest.TestCase):
    """Get2UsersIdFollowedListsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdFollowedListsResponse:
        """Test Get2UsersIdFollowedListsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdFollowedListsResponse`
        """
        model = Get2UsersIdFollowedListsResponse()
        if include_optional:
    ...
    def testGet2UsersIdFollowedListsResponse(self):
        """Test Get2UsersIdFollowedListsResponse"""
