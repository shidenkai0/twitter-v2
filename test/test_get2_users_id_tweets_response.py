...
class TestGet2UsersIdTweetsResponse(unittest.TestCase):
    """Get2UsersIdTweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdTweetsResponse:
        """Test Get2UsersIdTweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdTweetsResponse`
        """
        model = Get2UsersIdTweetsResponse()
        if include_optional:
    ...
    def testGet2UsersIdTweetsResponse(self):
        """Test Get2UsersIdTweetsResponse"""
