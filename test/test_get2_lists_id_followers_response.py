...
class TestGet2ListsIdFollowersResponse(unittest.TestCase):
    """Get2ListsIdFollowersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2ListsIdFollowersResponse:
        """Test Get2ListsIdFollowersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2ListsIdFollowersResponse`
        """
        model = Get2ListsIdFollowersResponse()
        if include_optional:
    ...
    def testGet2ListsIdFollowersResponse(self):
        """Test Get2ListsIdFollowersResponse"""
