...
class TestGet2SpacesIdTweetsResponse(unittest.TestCase):
    """Get2SpacesIdTweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2SpacesIdTweetsResponse:
        """Test Get2SpacesIdTweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2SpacesIdTweetsResponse`
        """
        model = Get2SpacesIdTweetsResponse()
        if include_optional:
    ...
    def testGet2SpacesIdTweetsResponse(self):
        """Test Get2SpacesIdTweetsResponse"""
