...
class TestStreamingTweetResponse(unittest.TestCase):
    """StreamingTweetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingTweetResponse:
        """Test StreamingTweetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingTweetResponse`
        """
        model = StreamingTweetResponse()
        if include_optional:
    ...
    def testStreamingTweetResponse(self):
        """Test StreamingTweetResponse"""
