...
class TestGet2UsersResponse(unittest.TestCase):
    """Get2UsersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersResponse:
        """Test Get2UsersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersResponse`
        """
        model = Get2UsersResponse()
        if include_optional:
    ...
    def testGet2UsersResponse(self):
        """Test Get2UsersResponse"""
