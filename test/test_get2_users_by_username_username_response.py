...
class TestGet2UsersByUsernameUsernameResponse(unittest.TestCase):
    """Get2UsersByUsernameUsernameResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersByUsernameUsernameResponse:
        """Test Get2UsersByUsernameUsernameResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersByUsernameUsernameResponse`
        """
        model = Get2UsersByUsernameUsernameResponse()
        if include_optional:
            return Get2UsersByUsernameUsernameResponse(
                data = {"created_at":"2013-12-14T04:35:55Z","id":"2244994945","name":"Twitter Dev","protected":false,"username":"TwitterDev"},
                errors = [
    ...
    def testGet2UsersByUsernameUsernameResponse(self):
        """Test Get2UsersByUsernameUsernameResponse"""
