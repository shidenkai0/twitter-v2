...
class TestGet2ListsIdMembersResponse(unittest.TestCase):
    """Get2ListsIdMembersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2ListsIdMembersResponse:
        """Test Get2ListsIdMembersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2ListsIdMembersResponse`
        """
        model = Get2ListsIdMembersResponse()
        if include_optional:
    ...
    def testGet2ListsIdMembersResponse(self):
        """Test Get2ListsIdMembersResponse"""
