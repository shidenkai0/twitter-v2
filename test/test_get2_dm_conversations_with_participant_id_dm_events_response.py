...
class TestGet2DmConversationsWithParticipantIdDmEventsResponse(unittest.TestCase):
    """Get2DmConversationsWithParticipantIdDmEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2DmConversationsWithParticipantIdDmEventsResponse:
        """Test Get2DmConversationsWithParticipantIdDmEventsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2DmConversationsWithParticipantIdDmEventsResponse`
        """
        model = Get2DmConversationsWithParticipantIdDmEventsResponse()
        if include_optional:
            return Get2DmConversationsWithParticipantIdDmEventsResponse(
                data = [
                    openapi_client.models.dm_event.DmEvent(
                ...
                meta = openapi_client.models.get2_dm_conversations_id_dm_events_response_meta.Get2DmConversationsIdDmEventsResponse_meta(
                    next_token = '0', 
                    previous_token = '0', 
                    result_count = 56, )
            )
    ...
    def testGet2DmConversationsWithParticipantIdDmEventsResponse(self):
        """Test Get2DmConversationsWithParticipantIdDmEventsResponse"""
