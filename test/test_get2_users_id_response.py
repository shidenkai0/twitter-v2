...
class TestGet2UsersIdResponse(unittest.TestCase):
    """Get2UsersIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdResponse:
        """Test Get2UsersIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdResponse`
        """
        model = Get2UsersIdResponse()
        if include_optional:
    ...
    def testGet2UsersIdResponse(self):
        """Test Get2UsersIdResponse"""
