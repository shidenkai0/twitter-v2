...
class TestGet2TweetsIdRetweetsResponse(unittest.TestCase):
    """Get2TweetsIdRetweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsIdRetweetsResponse:
        """Test Get2TweetsIdRetweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsIdRetweetsResponse`
        """
        model = Get2TweetsIdRetweetsResponse()
        if include_optional:
            return Get2TweetsIdRetweetsResponse(
                data = [
    ...
    def testGet2TweetsIdRetweetsResponse(self):
        """Test Get2TweetsIdRetweetsResponse"""
