...
class TestUsersRetweetsDeleteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersRetweetsDeleteResponse:
        """Test UsersRetweetsDeleteResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersRetweetsDeleteResponse`
        """
        model = UsersRetweetsDeleteResponse()
        if include_optional:
