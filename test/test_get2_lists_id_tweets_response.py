...
class TestGet2ListsIdTweetsResponse(unittest.TestCase):
    """Get2ListsIdTweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2ListsIdTweetsResponse:
        """Test Get2ListsIdTweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2ListsIdTweetsResponse`
        """
        model = Get2ListsIdTweetsResponse()
        if include_optional:
    ...
    def testGet2ListsIdTweetsResponse(self):
        """Test Get2ListsIdTweetsResponse"""
