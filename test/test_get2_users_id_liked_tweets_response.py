...
class TestGet2UsersIdLikedTweetsResponse(unittest.TestCase):
    """Get2UsersIdLikedTweetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdLikedTweetsResponse:
        """Test Get2UsersIdLikedTweetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdLikedTweetsResponse`
        """
        model = Get2UsersIdLikedTweetsResponse()
        if include_optional:
    ...
    def testGet2UsersIdLikedTweetsResponse(self):
        """Test Get2UsersIdLikedTweetsResponse"""
