...
class TestGet2DmConversationsIdDmEventsResponse(unittest.TestCase):
    """Get2DmConversationsIdDmEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2DmConversationsIdDmEventsResponse:
        """Test Get2DmConversationsIdDmEventsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2DmConversationsIdDmEventsResponse`
        """
        model = Get2DmConversationsIdDmEventsResponse()
        if include_optional:
    ...
    def testGet2DmConversationsIdDmEventsResponse(self):
        """Test Get2DmConversationsIdDmEventsResponse"""
