...
class TestGet2SpacesResponse(unittest.TestCase):
    """Get2SpacesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2SpacesResponse:
        """Test Get2SpacesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2SpacesResponse`
        """
        model = Get2SpacesResponse()
        if include_optional:
    ...
    def testGet2SpacesResponse(self):
        """Test Get2SpacesResponse"""
