...
class TestGet2TweetsSearchStreamResponse(unittest.TestCase):
    """Get2TweetsSearchStreamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsSearchStreamResponse:
        """Test Get2TweetsSearchStreamResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsSearchStreamResponse`
        """
        model = Get2TweetsSearchStreamResponse()
        if include_optional:
            return Get2TweetsSearchStreamResponse(
    ...
    def testGet2TweetsSearchStreamResponse(self):
        """Test Get2TweetsSearchStreamResponse"""
