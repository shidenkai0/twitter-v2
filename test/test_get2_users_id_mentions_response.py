...
class TestGet2UsersIdMentionsResponse(unittest.TestCase):
    """Get2UsersIdMentionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdMentionsResponse:
        """Test Get2UsersIdMentionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdMentionsResponse`
        """
        model = Get2UsersIdMentionsResponse()
        if include_optional:
    ...
    def testGet2UsersIdMentionsResponse(self):
        """Test Get2UsersIdMentionsResponse"""
