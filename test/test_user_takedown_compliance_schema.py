...
class TestUserTakedownComplianceSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserTakedownComplianceSchema:
        """Test UserTakedownComplianceSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserTakedownComplianceSchema`
        """
        model = UserTakedownComplianceSchema()
        if include_optional:
