...
class TestGet2UsersIdFollowersResponse(unittest.TestCase):
    """Get2UsersIdFollowersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdFollowersResponse:
        """Test Get2UsersIdFollowersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdFollowersResponse`
        """
        model = Get2UsersIdFollowersResponse()
        if include_optional:
    ...
    def testGet2UsersIdFollowersResponse(self):
        """Test Get2UsersIdFollowersResponse"""
