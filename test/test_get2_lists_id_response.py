...
class TestGet2ListsIdResponse(unittest.TestCase):
    """Get2ListsIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2ListsIdResponse:
        """Test Get2ListsIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2ListsIdResponse`
        """
        model = Get2ListsIdResponse()
        if include_optional:
            return Get2ListsIdResponse(
                data = openapi_client.models.list.List(
    ...
    def testGet2ListsIdResponse(self):
        """Test Get2ListsIdResponse"""
