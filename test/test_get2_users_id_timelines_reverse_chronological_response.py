...
class TestGet2UsersIdTimelinesReverseChronologicalResponse(unittest.TestCase):
    """Get2UsersIdTimelinesReverseChronologicalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdTimelinesReverseChronologicalResponse:
        """Test Get2UsersIdTimelinesReverseChronologicalResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdTimelinesReverseChronologicalResponse`
        """
        model = Get2UsersIdTimelinesReverseChronologicalResponse()
        if include_optional:
            return Get2UsersIdTimelinesReverseChronologicalResponse(
                ...
                meta = openapi_client.models.get2_users_id_mentions_response_meta.Get2UsersIdMentionsResponse_meta(
                    newest_id = '', 
                    next_token = '0', 
                    oldest_id = '', 
                    previous_token = '0', 
    ...
    def testGet2UsersIdTimelinesReverseChronologicalResponse(self):
        """Test Get2UsersIdTimelinesReverseChronologicalResponse"""
