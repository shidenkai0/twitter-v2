...
class TestGet2UsersIdMutingResponse(unittest.TestCase):
    """Get2UsersIdMutingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdMutingResponse:
        """Test Get2UsersIdMutingResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdMutingResponse`
        """
        model = Get2UsersIdMutingResponse()
        if include_optional:
    ...
    def testGet2UsersIdMutingResponse(self):
        """Test Get2UsersIdMutingResponse"""
