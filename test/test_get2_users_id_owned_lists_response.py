...
class TestGet2UsersIdOwnedListsResponse(unittest.TestCase):
    """Get2UsersIdOwnedListsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdOwnedListsResponse:
        """Test Get2UsersIdOwnedListsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdOwnedListsResponse`
        """
        model = Get2UsersIdOwnedListsResponse()
        if include_optional:
    ...
    def testGet2UsersIdOwnedListsResponse(self):
        """Test Get2UsersIdOwnedListsResponse"""
