...
class TestGet2UsersIdFollowingResponse(unittest.TestCase):
    """Get2UsersIdFollowingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdFollowingResponse:
        """Test Get2UsersIdFollowingResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdFollowingResponse`
        """
        model = Get2UsersIdFollowingResponse()
        if include_optional:
    ...
    def testGet2UsersIdFollowingResponse(self):
        """Test Get2UsersIdFollowingResponse"""
