...
class TestGet2DmEventsResponse(unittest.TestCase):
    """Get2DmEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2DmEventsResponse:
        """Test Get2DmEventsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2DmEventsResponse`
        """
        model = Get2DmEventsResponse()
        if include_optional:
    ...
    def testGet2DmEventsResponse(self):
        """Test Get2DmEventsResponse"""
