...
class TestGet2TweetsIdLikingUsersResponse(unittest.TestCase):
    """Get2TweetsIdLikingUsersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2TweetsIdLikingUsersResponse:
        """Test Get2TweetsIdLikingUsersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2TweetsIdLikingUsersResponse`
        """
        model = Get2TweetsIdLikingUsersResponse()
        if include_optional:
    ...
    def testGet2TweetsIdLikingUsersResponse(self):
        """Test Get2TweetsIdLikingUsersResponse"""
