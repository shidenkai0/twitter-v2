...
class TestGet2SpacesIdBuyersResponse(unittest.TestCase):
    """Get2SpacesIdBuyersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2SpacesIdBuyersResponse:
        """Test Get2SpacesIdBuyersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2SpacesIdBuyersResponse`
        """
        model = Get2SpacesIdBuyersResponse()
        if include_optional:
    ...
    def testGet2SpacesIdBuyersResponse(self):
        """Test Get2SpacesIdBuyersResponse"""
