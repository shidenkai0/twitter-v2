...
class TestGet2UsersIdListMembershipsResponse(unittest.TestCase):
    """Get2UsersIdListMembershipsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Get2UsersIdListMembershipsResponse:
        """Test Get2UsersIdListMembershipsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Get2UsersIdListMembershipsResponse`
        """
        model = Get2UsersIdListMembershipsResponse()
        if include_optional:
    ...
    def testGet2UsersIdListMembershipsResponse(self):
        """Test Get2UsersIdListMembershipsResponse"""
