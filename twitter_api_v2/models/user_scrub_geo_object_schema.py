...
class UserScrubGeoObjectSchema(BaseModel):
    ...
    up_to_tweet_id: Annotated[str, Field(strict=True)] = Field(description="Unique identifier of this Tweet. This is returned as a string in order to avoid complications with languages and tools that cannot handle large integers.")
    user: UserComplianceSchemaUser
    __properties: ClassVar[List[str]] = ["event_at", "up_to_tweet_id", "user"]

    @field_validator('up_to_tweet_id')
    def up_to_tweet_id_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "user": UserComplianceSchemaUser.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
