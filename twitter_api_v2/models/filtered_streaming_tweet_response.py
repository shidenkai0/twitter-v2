...
class FilteredStreamingTweetResponse(BaseModel):
    ...
    matching_rules: Optional[List[FilteredStreamingTweetResponseMatchingRulesInner]] = Field(default=None, description="The list of rules which matched the Tweet")
    __properties: ClassVar[List[str]] = ["data", "errors", "includes", "matching_rules"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": Tweet.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            ...
            "matching_rules": [FilteredStreamingTweetResponseMatchingRulesInner.from_dict(_item) for _item in obj.get("matching_rules")] if obj.get("matching_rules") is not None else None
        })
        return _obj
