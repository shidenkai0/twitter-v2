...
class ContextAnnotation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["domain", "entity"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "domain": ContextAnnotationDomainFields.from_dict(obj.get("domain")) if obj.get("domain") is not None else None,
            "entity": ContextAnnotationEntityFields.from_dict(obj.get("entity")) if obj.get("entity") is not None else None
        })
        return _obj
