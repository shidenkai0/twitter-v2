...
class Get2TweetsIdQuoteTweetsResponse(BaseModel):
    ...
    meta: Optional[Get2TweetsIdQuoteTweetsResponseMeta] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [Tweet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            ...
            "meta": Get2TweetsIdQuoteTweetsResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj
