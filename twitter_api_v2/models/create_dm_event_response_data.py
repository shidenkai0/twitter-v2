...
class CreateDmEventResponseData(BaseModel):
    ...
    """ # noqa: E501
    dm_conversation_id: Annotated[str, Field(strict=True)] = Field(description="Unique identifier of a DM conversation. This can either be a numeric string, or a pair of numeric strings separated by a '-' character in the case of one-on-one DM Conversations.")
    dm_event_id: Annotated[str, Field(strict=True)] = Field(description="Unique identifier of a DM Event.")
    __properties: ClassVar[List[str]] = ["dm_conversation_id", "dm_event_id"]
    ...
    @field_validator('dm_event_id')
    def dm_event_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dm_event_id": obj.get("dm_event_id")
        })
        return _obj
