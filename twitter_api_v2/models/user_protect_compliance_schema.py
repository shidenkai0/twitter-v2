...
class UserProtectComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_protect"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_protect
        if self.user_protect:
            _dict['user_protect'] = self.user_protect.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_protect": UserComplianceSchema.from_dict(obj.get("user_protect")) if obj.get("user_protect") is not None else None
        })
        return _obj
