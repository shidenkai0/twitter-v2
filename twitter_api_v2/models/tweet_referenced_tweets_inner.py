...
class TweetReferencedTweetsInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('retweeted', 'quoted', 'replied_to'):
            raise ValueError("must be one of enum values ('retweeted', 'quoted', 'replied_to')")
        return value
