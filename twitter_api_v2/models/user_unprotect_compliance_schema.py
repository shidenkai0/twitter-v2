...
class UserUnprotectComplianceSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_unprotect"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_unprotect
        if self.user_unprotect:
            _dict['user_unprotect'] = self.user_unprotect.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_unprotect": UserComplianceSchema.from_dict(obj.get("user_unprotect")) if obj.get("user_unprotect") is not None else None
        })
        return _obj
