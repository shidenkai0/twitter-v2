...
class Get2ComplianceJobsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[Annotated[List[ComplianceJob], Field(min_length=1)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ComplianceJob.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "errors": [Problem.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "meta": Get2ComplianceJobsResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj
