...
class UserComplianceData(BaseModel):
    ...
    one_of_schemas: List[str] = Literal["UserDeleteComplianceSchema", "UserProfileModificationComplianceSchema", "UserProtectComplianceSchema", "UserScrubGeoSchema", "UserSuspendComplianceSchema", "UserUndeleteComplianceSchema", "UserUnprotectComplianceSchema", "UserUnsuspendComplianceSchema", "UserWithheldComplianceSchema"]
