...
class TweetsApi:
    ...
    def add_or_delete_rules(
        ...
        delete_all: Annotated[Optional[StrictBool], Field(description="Delete All can be used to delete all of the rules associated this client app, it should be specified with no other parameters. Once deleted, rules cannot be recovered.")] = None,
        ...
        :type dry_run: bool
        :param delete_all: Delete All can be used to delete all of the rules associated this client app, it should be specified with no other parameters. Once deleted, rules cannot be recovered.
    ...
    def _add_or_delete_rules_serialize(
        ...
        if delete_all is not None:
            ...
            _query_params.append(('delete_all', delete_all))
    ...
    def find_tweets_that_retweet_a_tweet(
        ...
        _param = self._find_tweets_that_retweet_a_tweet_serialize(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            tweet_fields=tweet_fields,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Get2TweetsIdRetweetsResponse",
    ...
    @validate_call
    def find_tweets_that_retweet_a_tweet_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="A single Tweet ID.")],
        max_results: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results.")] = None,
        pagination_token: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="This parameter is used to get the next 'page' of results.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Get2TweetsIdRetweetsResponse]:
        """Retrieve Tweets that retweet a Tweet.
    ...
    @validate_call
    def find_tweets_that_retweet_a_tweet_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="A single Tweet ID.")],
        max_results: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results.")] = None,
        pagination_token: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="This parameter is used to get the next 'page' of results.")] = None,
    ...
    def _find_tweets_that_retweet_a_tweet_serialize(
        self,
        id,
        max_results,
        pagination_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/tweets/{id}/retweets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
